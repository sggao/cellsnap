...
class CNN_cell1024_channel2(nn.Module):
    def __init__(self):
        super().__init__()
...
train_size, test_size = train_nbhd.shape[0], test_nbhd.shape[0]
model_save_path = os.path.join(load_path, "cnn", f"cnn_1024_l{l}_layer6_testimgsize:1024_checkpoints", "epochs")
