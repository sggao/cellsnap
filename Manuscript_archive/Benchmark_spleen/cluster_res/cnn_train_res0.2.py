...
cell_nbhd = np.load(os.path.join(load_path, "cell_nbhd_res0.2_k20.npy"))
...
train_size, test_size = train_nbhd.shape[0], test_nbhd.shape[0]
model_save_path = os.path.join(load_path, "cnn", f"cnn_512_l{l}_layer6_testres:0.2_checkpoints", "epochs")
