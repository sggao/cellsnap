...
cell_nbhd = np.load(os.path.join(load_path, "cell_nbhd_res1_k20.npy"))
...
train_size, test_size = train_nbhd.shape[0], test_nbhd.shape[0]
model_save_path = os.path.join(load_path, "cnn", f"cnn_512_l{l}_layer6_testres:1_checkpoints", "epochs")
