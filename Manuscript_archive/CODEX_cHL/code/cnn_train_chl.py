...
# bokai 
metaload_path = '/mnt/cloud1/sheng-projects/st_projects/spatial_clust/spatial-clust-scripts/ipynb/Bokai_reorg/cHL_codex/data/'
# sheng other meta
metaload_path2 = '../../../../../data/chl/cHL/processed_data' # only for images etc
...
load_path = '../../../../../data/chl/cHL/' # this is from sheng
image_folder = os.path.join(load_path, "processed_data", "single_cell_images")
dataset = SingleCellImageDataset_Stream(os.path.join(image_folder, "size512_channels2_qr0.9_images"),
                                        train_mask, cell_nbhd, use_transform = True)
...
class CNN_cell512_channel2_layer6(nn.Module):
    def __init__(self):
        ...
        self.fc4 = nn.Linear(128, 17) # change due to cell type labels
...
model_save_path = os.path.join(metaload_path, "cnn_0325", f"cnn_512_l{l}_layer6", "epochs")
#model_save_path = os.path.join(metaload_path, "cnn", f"cnn_512_l{l}_layer6_human", "epochs")
